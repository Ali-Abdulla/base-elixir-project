defmodule Mymix.GenericServer do
...
defmodule Mymix.PledgeServerHandRolled do

	@name :pledge_server_hand_rolled

	alias Mymix.GenericServer
	...
	def send_pledge_to_service(_name, _amount) do
		# CODE GOES HERE TO SEND PLEDGE TO ETERNAL SERVICE
		{:ok, "pledge-#{:rand.uniform(1000)}"}
	end
end

# alias Mymix.PledgeServerHandRolled
